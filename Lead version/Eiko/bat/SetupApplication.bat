...
:: Android packaging
set AND_CERT_NAME="Eiko"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\Eiko.p12
...
set IOS_DEV_CERT_PASS=banane
set IOS_PROVISION=cert\Eiko.mobileprovision
